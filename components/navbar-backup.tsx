          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <div className="p-6">
                  <div className="mb-4">
                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Get Involved</h4>
                  </div>
              ...
              <div className="px-3 py-2">
                ...
                {isGetInvolvedOpen && (
                  <div className="mt-2 pl-4">
                    ...
                    {/* Our Interns Sub-section */}
                    <div className="mb-2">
                      <button
                        onClick={() => setIsOurInternsOpen(!isOurInternsOpen)}
                        className="flex items-center justify-between w-full text-sm text-gray-600 hover:text-green-600 font-medium py-1"
                      >
                        <div className="flex items-center">
                          <div className="w-1.5 h-1.5 bg-purple-600 rounded-full mr-2"></div>
                        ...
                        <ChevronDown
                          className={`h-3 w-3 transition-transform ${isOurInternsOpen ? "rotate-180" : ""}`}
                        />
                      </button>
                      ...
                      {isOurInternsOpen && (
                        <div className="mt-1 pl-4 space-y-1">
                          ...
                          <Link
                            href="/get-involved/our-notable-interns"
                            className="block py-2 text-sm text-gray-600 hover:text-green-600 transition-colors"
                            onClick={() => setIsOpen(false)}
                          >
                            Our Notable Interns
                          ...
                          <Link
                            href="/get-involved/leadership-team"
                            className="block py-2 text-sm text-gray-600 hover:text-green-600 transition-colors"
                            onClick={() => setIsOpen(false)}
                          >
                            Leadership Team
                          ...
                          <Link
                            href="/get-involved/executive-team"
                            className="block py-2 text-sm text-gray-600 hover:text-green-600 transition-colors"
                            onClick={() => setIsOpen(false)}
                          >
                            Executive Team
                          ...
                          <Link
                            href="/get-involved/board-of-directors"
                            className="block py-2 text-sm text-gray-600 hover:text-green-600 transition-colors"
                            onClick={() => setIsOpen(false)}
                          >
                            Board of Directors
                          ...
                          <Link
                            href="/get-involved/advisory-board"
                            className="block py-2 text-sm text-gray-600 hover:text-green-600 transition-colors"
                            onClick={() => setIsOpen(false)}
                          >
                            Advisory Board
