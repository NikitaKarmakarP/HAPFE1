        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              HAPEF is committed to empowering rural communities across India through sustainable livelihood initiatives, climate action, gender equality programs, and comprehensive community development projects, with the objective of fostering inclusive growth and long-term positive transformation.
            </p>
