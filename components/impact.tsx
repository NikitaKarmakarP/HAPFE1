  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-green-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div
          ref={headerRef}
          className={`text-center mb-16 transition-all duration-1000 ${headerInView
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-10'
            }`}
        >
          <div className={`inline-flex items-center gap-2 bg-gradient-to-r from-green-100 to-emerald-100 px-6 py-3 rounded-full mb-8 shadow-lg transition-all duration-700 ${headerInView ? 'scale-100 rotate-0' : 'scale-95 rotate-3'
            ...
            <Award className={`h-5 w-5 text-green-600 transition-all duration-500 ${headerInView ? 'rotate-0' : 'rotate-12'
              }`} />
        ...
        <div
          ref={storiesRef}
          className={`bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl p-8 lg:p-12 shadow-xl relative overflow-hidden transition-all duration-1000 ${storiesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        >
          {/* Background decorative elements */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative">
            <div className={`transition-all duration-1000 delay-200 ${storiesInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
              }`}>
              ...
              <div className="space-y-6">
                ...
                <div className={`bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group border border-green-100 relative overflow-hidden ${storiesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
                  ...
                  <div className="flex items-start gap-4 relative">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-bold text-green-700">Punam Devi</div>
                ...
                <div className={`bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group border border-blue-100 relative overflow-hidden ${storiesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
                  ...
                  <div className="flex items-start gap-4 relative">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-bold text-blue-700">Karmela Tudu</div>
            ...
            <div className={`transition-all duration-1000 delay-300 ${storiesInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
              }`}>
